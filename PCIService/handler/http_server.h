...
#ifndef PCI_HTTP_SERVER_H
#define PCI_HTTP_SERVER_H
...
// 定义http请求handler
using ReqHandler = std::function<std::string (std::string, std::string, mg_connection *c, OnRspCallback)>;
